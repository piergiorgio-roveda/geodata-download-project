...
* **LICENSE**: GPL‑3 (code) + Statistics Finland open‑data terms for the polygons ([GitHub][3])
...
* **LICENSE**: BSD 2‑Clause ([GitHub][4])
* **Description**: R toolkit that **pulls live WFS/OGC API data from Statistics Finland**—municipality & region borders, ZIP‑code polygons, population grids (1 km → 100 m)—and returns ready‑to‑map *sf* objects. ([GitHub][5])
...
* **LICENSE**: *No license file — verify before reuse* ([GitHub][2])
...
* **URL**: [https://github.com/wmgeolab/geoBoundaries](https://github.com/wmgeolab/geoBoundaries)
* **LICENSE**: CC BY 4.0 / ODbL (open boundary database) ([GitHub][3])
...
* **LICENSE**: *No license specified* (check usage terms) ([Gist][4])
